...
st.title("📋 Опросник: Технический аудит ИТ и ИБ (2026) v4.2")
...
def make_expert_excel(c_info, results, final_score):
    ...
    for k, v in results.items():
        ...
        if "Windows XP/Vista/7/8" in k and v > 0:
            is_risk = True; recommendation = rec_map["Windows XP/Vista/7/8"]
...
st.info("Khalil Audit System v4.2 | Almaty 2026")
