...
st.title("📋 Опросник: Технический аудит ИТ и ИБ (2026) v6.1 (Server Logic Update)")
...
with st.expander("📖 Инструкция по заполнению (нажмите, чтобы развернуть)"):
    ...
    **Обновление v6.1:** Скорректирована логика проверки серверов. Количество операционных систем должно быть не меньше количества виртуальных машин.
    """)
