...
with col_h1:
    ...
    # Сайт компании теперь обязательный
    ...
    if clean_domain and "." in clean_domain:
        ...
        # Если сайт не введен, блокируем возможность корректного формирования email
...
def make_expert_excel(c_info, results, final_score):
    ...
    bg_color = "92D050" if final_score > 70 else "FFC000"
