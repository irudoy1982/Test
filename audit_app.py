...
if st.toggle("Используются внутренние ИС", key="is_block_toggle"):
    ...
    with col_is1:
        data['1.5.1. Почтовая система'] = st.selectbox("Тип почты:", ["Exchange (On-Prem)", "Microsoft 365", "Google Workspace", "Yandex/Mail.ru Cloud", "Собственный сервер", "Нет"], key="mail_sys")
